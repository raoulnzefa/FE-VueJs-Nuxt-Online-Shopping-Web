...
export const mutations = {
    ...
    //mutation "SET_RELATED_DATA"
    SET_RELATED_DATA(state, payload) {
    ...
    getDetailProduct({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
        ...
        .then(response => {
            ...
            //commit ke mutation SET_RELATED_DATA dengan response data
            commit('SET_RELATED_DATA', response.data.related)
            //resolve promise
            resolve()
        })
      })
