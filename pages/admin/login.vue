          ...
          <div class="card-body">
            ...
            <form @submit.prevent="login">
                <div class="input-group mb-3">
                    ...
                    <input class="form-control shadow-none" v-model="user.email" :class="{'is-invalid': validation.email }" type="email" placeholder="Email Address">
                </div>
                ...
                <div class="input-group mb-4">
                    ...
                    <input class="form-control shadow-none" v-model="user.password" :class="{ 'is-invalid': validation.password }" type="password" placeholder="Password">
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <button class="btn btn-primary shadow-none rounded-sm px-4 w-100" type="submit">LOGIN</button>
                  </div>
                </div>
            </form>
          </div>
