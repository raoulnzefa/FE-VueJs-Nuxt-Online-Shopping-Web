                ...
                <form @submit.prevent="updateUser">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" v-model="user.email" placeholder="Masukkan Email Address" class="form-control">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="password" v-model="user.password_confirmation" placeholder="Masukkan Konfirmasi Password" class="form-control">
                      </div>
                    </div>
                  </div>
