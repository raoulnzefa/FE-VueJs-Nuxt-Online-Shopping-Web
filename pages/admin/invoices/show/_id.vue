      ...
      <div class="fade-in">
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ invoice.courier }} / {{ invoice.courier_service}} / Rp.{{ formatPrice(invoice.courier_cost) }}</td>
                  </tr>
                  <tr>
                    <td>CITY</td>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <button v-if="invoice.status == 'pending'" class="btn btn-primary"><i class="fa fa-circle-notch fa-spin"></i> {{ invoice.status }}</button>
            ...
            <div class="card border-0 rounded shadow-sm border-top mt-4">
              <div class="card-header">
