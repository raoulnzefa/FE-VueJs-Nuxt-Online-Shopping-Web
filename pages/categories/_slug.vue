<template>
  ...
  <div class="py-lg-12 py-11 pt-5 pb-5" style="background: rgb(255, 255, 255);">
    <div class="container">
      <Breadcrumbs />
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-6" v-for="product in category.products" :key="product.id">
...
export default {
  ...
  head() {
    return {
    title: `Category : ${this.category.name} @andaristudio - Creative graphic design, Bullet Journal and Illustrations!`,
      meta: [
        {
          hid: 'og:title',
          name: 'og:title',
          content: 'Category : ${this.category.name} @andaristudio - Creative graphic design, Bullet Journal and Illustrations!'
        },
        {
          hid: 'og:site_name',
          name: 'og:site_name',
        ...
        },
        {
          hid: 'description',
          name: 'description',
          content: 'Category : ${this.category.name} Officially Online Store Aesthetic Stuff'
        },
      ]
    }
  },
